                ...
                >
                  ...
                  <div className="flex gap-5">
                    ...
                    <div className="flex-1 min-w-0 -mt-0.5">
                      ...
                      {/* Example link for Armstrong finding #1 */}
                      {isArmstrong && i === 0 && (
                        <Link
                          to="/ejemplo/ruta-optimizada"
                          className="mt-3 inline-flex items-center gap-2 text-xs font-semibold text-primary hover:text-primary/80 transition-colors"
                        >
                          <MapPin className="h-3.5 w-3.5" />
                          Ver ejemplo en vivo: Guadalajara → Querétaro →
                        </Link>
                      )}
                    </div>
                  </div>
