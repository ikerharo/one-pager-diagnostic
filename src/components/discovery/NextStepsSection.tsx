      ...
      <div className="container mx-auto max-w-4xl px-6">
        ...
        <AnimatedSection>
          <motion.div variants={itemVariants} className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-bold uppercase tracking-wider text-primary">Plan de accion</span>
          </motion.div>
          <motion.h2
            variants={itemVariants}
            className="text-2xl font-bold tracking-tight md:text-3xl text-foreground"
          ...
          <motion.p
            ...
            className="mt-2 text-muted-foreground max-w-2xl"
          >
            Plan de accion con responsables y tiempos estimados.
          </motion.p>
          ...
          {closingQuote && (
            <motion.blockquote
              variants={itemVariants}
              className="mt-10 border-l-4 border-primary/40 pl-5 py-3"
            >
              <p className="text-sm italic text-muted-foreground leading-relaxed">
                "{closingQuote}"
              </p>
              {closingQuoteAuthor && (
                <footer className="mt-2 text-xs font-medium text-foreground/70">
                  — {closingQuoteAuthor}
                </footer>
              )}
            </motion.blockquote>
